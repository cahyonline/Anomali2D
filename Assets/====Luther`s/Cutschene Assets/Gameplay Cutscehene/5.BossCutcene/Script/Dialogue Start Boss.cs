...
public class DialogueStartBoss : MonoBehaviour
{
    [System.Serializable]
    ...
    public DialogueTriggerBoss dialogueTriggerBoss; // Reference to DialogueTrigger script
    ...
    void EndDialogue()
    {
        ...
        dialogueTriggerBoss.DoneDialog();
