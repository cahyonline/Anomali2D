...
public class DialogueStartCS3 : MonoBehaviour
{
    [System.Serializable]
    ...
    public DialogueTriggerCS3 dialogueTriggerCS3; // Reference to DialogueTrigger script
    //public PlayerControl PlayerControllerScriptGoesHere;
    public CutscenePlayer3 cutscenePlayer3;
    ...
    void EndDialogue()
    {
        cutscenePlayer3.ResumeCutscene();
