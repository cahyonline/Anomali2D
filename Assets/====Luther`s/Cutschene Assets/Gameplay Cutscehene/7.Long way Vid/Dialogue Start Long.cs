...
public class DialogueStartLong : MonoBehaviour
{
    [System.Serializable]
    ...
    public DialogueTriggerLong dialogueTriggerLong; // Reference to DialogueTrigger script
    ...
    void EndDialogue()
    {
        ...
        dialogueTriggerLong.DoneDialog();
