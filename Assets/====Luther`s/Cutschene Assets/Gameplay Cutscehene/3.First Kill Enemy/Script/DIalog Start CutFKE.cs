...
public class DialogueStartCSFKE : MonoBehaviour
{
    [System.Serializable]
    ...
    public DialogueTriggerCSFKE dialogueTriggerCSFKE; // Reference to DialogueTrigger script
    ...
    void EndDialogue()
    {
        ...
        dialogueTriggerCSFKE.DoneDialog();
